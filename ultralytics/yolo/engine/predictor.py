...
class BasePredictor:
    ...
    def save_preds(self, vid_cap, idx, save_path):
        ...
        if self.dataset.mode == 'image':
            ...
            frame=getattr(self.dataset, 'frame', 0)
            str_path=str(self.save_dir / 'imgs' / 'test_') + ('' if self.dataset.mode == 'image' else f'_{frame}') +".png"
            import os
            if not os.path.exists(str(self.save_dir / 'imgs')):
                os.makedirs(str(self.save_dir / 'imgs'))
            cv2.imwrite(str_path,im0)
